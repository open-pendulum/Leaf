...
OpenGLShader::OpenGLShader(const std::string &vertexSrc,
    ...
    if (isCompiled == GL_FALSE) {
        ...
        LEAF_CORE_ERROR("Vertex shader compilation failure! {0}",
                        infoLog.data());
    ...
    if (isCompiled == GL_FALSE) {
        ...
        LEAF_CORE_ERROR("Fragment shader compilation failure! {0}",
                        infoLog.data());
        LEAF_CORE_ASSERT(false, "Fragment shader compilation failure!");
        return;
    }
    ...
    if (isLinked == GL_FALSE) {
        ...
        LEAF_CORE_ERROR("Shader link failure! {0}", infoLog.data());
        LEAF_CORE_ASSERT(false, "Shader link failure!");
        return;
    }
