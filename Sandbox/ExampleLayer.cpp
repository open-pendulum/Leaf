...
ExampleLayer::ExampleLayer() :
    ...
    Leaf::Ref<Leaf::IndexBuffer> indexBuffer =
        Leaf::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
    ...
    Leaf::Ref<Leaf::IndexBuffer> squareIndexBuffer = Leaf::IndexBuffer::Create(
    ...
    mFlatColorShader = Leaf::Shader::Create("flat", flatColorShaderVertexSrc,
...
void ExampleLayer::OnUpdate(Leaf::Timestep ts) {
...
void ExampleLayer::OnEvent(Leaf::Event &event) {
